...
public class Decimal extends AppCompatActivity {
    ...
    public void onClick2(View v) {
        Intent intent = new Intent(Decimal.this, Programmer.class);
    ...
    public void onClick1(View view) {
        ...
        if (numberField.length() > 20) {
            Toast.makeText(this, "Можно ввести до 20 цифр. ", Toast.LENGTH_SHORT).show();
    ...
    public void onClick(View view) {
        ...
        if (Dec.isChecked() && Oct.isChecked() && Hex.isChecked()) {
            ...
            if (arrayList.isEmpty()) {
                ...
                int a = Integer.parseInt(arrayList.get(0), 10);
                resultField.setText(Integer.toBinaryString(a));
            }
            ...
            if (arrayList.isEmpty()) {
                ...
                int a = Integer.parseInt(arrayList.get(0), 10);
                resultField.setText(Integer.toOctalString(a));
            }
            ...
            if (arrayList.isEmpty()) {
                ...
                int a = Integer.parseInt(arrayList.get(0), 10);
                String bnum = Integer.toHexString(a);
                resultField.setText(bnum);
            }
